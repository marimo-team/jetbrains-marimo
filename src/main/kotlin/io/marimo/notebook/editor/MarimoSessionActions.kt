 ...
 */
abstract class MarimoSessionAction(
    private val enabled: (MarimoSessionSnapshot?) -> Boolean,
) : AnAction(), DumbAware {
    ...
    final override fun update(e: AnActionEvent) {
        ...
        e.presentation.isEnabled = enabled(project.serviceIfCreated<MarimoServerService>()?.statusFor(file))
    }
