...
class MarimoHarnessTest {
    ...
    @Test
    fun genericPromptArgsHaveNoHarnessSpecificFlag() {
        assertEquals(
    ...
    @Test
    fun tabTitlePairsHarnessLabelWithFileName() {
        assertEquals("Claude · stocks.py", MarimoHarness.CLAUDE.tabTitle("stocks.py"))
    }

    @Test
    fun terminalActionLabelsDistinguishTheExplicitFallbacks() {
    ...
    @Test
    fun installHintNamesTheHarness() {
        assertEquals(true, MarimoHarness.CLAUDE.installHint.contains("Claude"))
    }

    @Test
    fun findOnPathTrueWhenAnyDirHasExecutable() {
    ...
    @Test
    fun findOnPathFalseWhenNoDirHasExecutable() {
        val path = listOf("/a", "/b").joinToString(java.io.File.pathSeparator)
        assertEquals(false, MarimoHarness.CLAUDE.findOnPath(path) { false })
    }

    @Test
    fun findOnPathTrueWhenPathIsNull() {
    ...
    @Test
    fun findOnPathTriesGivenExecutableExtensions() {
